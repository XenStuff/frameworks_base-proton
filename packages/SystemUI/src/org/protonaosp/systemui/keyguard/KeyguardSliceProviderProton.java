...
public class KeyguardSliceProviderProton extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        AddShadowTask(KeyguardSliceProviderProton keyguardSliceProviderProton, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(keyguardSliceProviderProton);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = keyguardSliceProviderProton.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            ...
            synchronized (this) {
                ...
                keyguardSliceProviderProton = this.mProviderReference.get();
            }
