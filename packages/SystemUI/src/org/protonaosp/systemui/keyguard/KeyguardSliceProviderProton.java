package org.protonaosp.systemui.keyguard;
...
public class KeyguardSliceProviderProton extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderProton> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderProton keyguardSliceProviderProton, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderProton);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderProton.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderProton keyguardSliceProviderProton;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderProton = (KeyguardSliceProviderProton) mProviderReference.get();
            }
            if (keyguardSliceProviderProton != null) {
                keyguardSliceProviderProton.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderProton#onBindSlice");
        Slice slice;
